package com.test.application.aspect;
...
public class Logger {
    ...
    @Before("execution(* com.test.application.service.*.*(..)) || execution(* com.test.application.controller.*.*(..))")
    ...
    @After("execution(* com.test.application.service.*.*(..)) || execution(* com.test.application.controller.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.test.application.service.*.*(..))", throwing = "exception")
